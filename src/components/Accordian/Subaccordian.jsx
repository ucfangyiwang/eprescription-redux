...
const Subaccordian = ({ title, content }) => {
  ...
  return (
    <div className="accordion-item">
      <div
        className="accordion-title bg-blue-50 mt-2 mb-2 p-2 grid grid-cols-12 cursor-pointer"
          ...
          <div className="grid grid-flow-row">
            ...
            <div className="row-span-1 mb-2">
              <div className="p-2 bg-gray-100 flex">
                ...
                <div className="w-10/12">
                  <select class="bg-gray-100 text-gray-900 text-xs w-full border-none">
                    <option selected="">Alcoholic Fatty Lever | E17.7</option>
            ...
            <div className="row-span-1 mb-2 flex">
              <div className="w-1/2 flex">
                <span className="self-center">
                  <img src="/img/medicine-tick.svg" className="w-3 h-3"></img>
                </span>
